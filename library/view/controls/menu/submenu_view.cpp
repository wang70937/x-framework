...
namespace view
{
    ...
    // static
    const char SubmenuView::kViewClassName[] = "view/SubmenuView";
    ...
    bool SubmenuView::GetDropFormats(int* formats,
    ...
    bool SubmenuView::CanDrop(const ui::OSExchangeData& data)
    {
        DCHECK(GetMenuItem()->GetMenuController());
    ...
    bool SubmenuView::SkipDefaultKeyEventProcessing(const KeyEvent& e)
    {
        return FocusManager::IsTabTraversalKeyEvent(e);
    }
