...
#ifndef __view_tree_view2_h__
#define __view_tree_view2_h__
...
namespace view
{
    ...
    class TreeView2 : public View, ui::TreeModelObserver
    {
    public:
        TreeView2();
        virtual ~TreeView2();
        ...
        // of the controller.
        void SetController(TreeViewController2* controller)
        {
 ...
 //       virtual void OnContextMenu(const POINT& location);
    ...
    private:
        ...
        {
            explicit TreeViewWrapper(TreeView2* view) : tree_view(view) {}
            TreeView2* tree_view;
        };
        ...
        // The controller.
        TreeViewController2* controller_;
        ...
        DISALLOW_COPY_AND_ASSIGN(TreeView2);
    };

} //namespace view

#endif //__view_tree_view2_h__