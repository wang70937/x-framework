...
#ifndef __view_table_view2_h__
#define __view_table_view2_h__
...
#include "native_table_wrapper.h"
...
namespace view
{
    ...
    class TableView2 : public View, public ui::TableModelObserver
    {
    public:
