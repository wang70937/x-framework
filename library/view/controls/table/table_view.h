...
#ifndef __view_table_view_h__
#define __view_table_view_h__
...
namespace view
{
    ...
    class TableView : public NativeControl, public ui::TableModelObserver
    {
    public:
    ...
    private:
        ...
        static LRESULT CALLBACK TableWndProc(HWND window, UINT message,
