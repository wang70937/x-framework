...
#ifndef __gantt_view_delegate_h__
#define __gantt_view_delegate_h__
...
class GanttViewDelegate : public view::ViewDelegate
{
public:
    GanttViewDelegate();
    virtual ~GanttViewDelegate();
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(GanttViewDelegate);
};

#endif //__gantt_view_delegate_h__