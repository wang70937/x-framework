...
#ifndef __app_view_delegate_h__
#define __app_view_delegate_h__
...
class AppViewDelegate : public view::ViewDelegate
{
public:
    AppViewDelegate();
    virtual ~AppViewDelegate();
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(AppViewDelegate);
};

#endif //__app_view_delegate_h__